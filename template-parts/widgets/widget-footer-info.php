<div class="widget-footer-info">
	...
	<p><a href="<?php echo cm_get_option('fbpage');?>" target="_blank"><i class="fa fa-facebook-square"></i> Facebook </a> - <a href="<?php echo cm_get_option('twtuser');?>" target="_blank"><i class="fa fa-twitter"></i> Twitter</a></p> 
</div>